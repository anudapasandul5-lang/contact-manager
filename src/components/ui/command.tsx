...
function Command({ className, ...props }: React.ComponentProps<typeof CommandPrimitive>) {
  return (
    <CommandPrimitive
      data-slot="command"
      className={cn(
        "flex h-full w-full flex-col overflow-hidden rounded-xl bg-[var(--card)] text-[var(--foreground)]",
        className,
      )}
      {...props}
    />
...
function CommandList({ className, ...props }: React.ComponentProps<typeof CommandPrimitive.List>) {
  return (
    <CommandPrimitive.List
      ...
      className={cn("max-h-[360px] overflow-y-auto overflow-x-hidden px-2 py-2", className)}
      {...props}
    />
  );
}
  ...
  return (
    <CommandPrimitive.Item
      ...
      className={cn(
        ...
        "data-[selected=true]:bg-[rgba(99,102,241,0.08)] data-[selected=true]:text-[var(--foreground)]",
