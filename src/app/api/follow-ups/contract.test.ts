...
test("follow-up schema defines the expected owner-scoped table fields", () => {
...
test("follow-up migration enforces one open follow-up per user and contact", () => {
  assert.match(
    migrationSource,
...
test("follow-up migration provides transactional completion with optional next scheduling", () => {
